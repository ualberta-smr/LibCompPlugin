...
public class DataLibrary {
    ...
    public DataLibrary(int id, int library_id, int domain_id, String repository, String name, int year, int month, String aPackage, double popularity, double release_frequency, double issue_closing_time, double issue_response_time, double performance, double security, double backwards_compatibility) {
        this.id = id;
